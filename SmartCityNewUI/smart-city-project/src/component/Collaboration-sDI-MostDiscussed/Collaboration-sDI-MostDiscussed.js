...
class CollaborationSDIMostDiscussed extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      APIResponse: "",
      cardCounts:  sessionStorage.getItem("MdIdeaCardCount")?parseInt(sessionStorage.getItem("MdIdeaCardCount")):4,
      DeleteSubmit: false,
  ...
  componentDidMount() {
    this.getAllIdeas();
    if(sessionStorage.getItem("MdIdeaCardCount"))
    {
  ...
  getAllIdeas() {
    ...
    fetch(
      process.env.REACT_APP_API_URL+"Ideas/GetMostDiscussedIdeas",
      requestOptions
    )
  ...
  CardDetails = (CardID) => {
    if (
      ...
      sessionStorage.setItem("MdIdeaCardCount",this.state.cardCounts);
      ...
      <Container className="tab-card-container-style">
        ...
        <Row>
          ...
          <Col xs="12" sm="12" md="8" lg="8" xl="8" xxl="8">
            {((this.state.totalDiscussCard > this.state.cardCounts) && (100 > this.state.cardCounts)) && (
              <Button
