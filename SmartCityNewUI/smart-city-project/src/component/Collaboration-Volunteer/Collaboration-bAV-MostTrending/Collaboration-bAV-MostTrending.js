...
class CollaborationBAVMostTrending extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      APIResponse: "",
      cardCounts: sessionStorage.getItem("MtbavCardCount")?parseInt(sessionStorage.getItem("MtbavCardCount")):4,
      DeleteSubmit: false,
  ...
  componentDidMount() {
    this.getAllIdeas();
    if(sessionStorage.getItem("MtbavCardCount"))
    {
  ...
  getAllIdeas() {
    ...
    fetch(
      process.env.REACT_APP_API_URL+"Volunteer/MostTrending",
      requestOptions
    )
  ...
  CardDetails = (CardID) => {
    if (
      ...
      sessionStorage.setItem("MtbavCardCount",this.state.cardCounts);
      ...
      <Container className="tab-card-container-style">
        ...
        <Row>
          ...
          <Col xs="12" sm="12" md="8" lg="8" xl="8" xxl="8">
            {((this.state.totalTrendingCardCount > this.state.cardCounts) && (100 > this.state.cardCounts)) && (
              <Button
