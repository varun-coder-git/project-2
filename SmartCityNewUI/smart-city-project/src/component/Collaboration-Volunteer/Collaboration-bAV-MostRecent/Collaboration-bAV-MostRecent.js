...
class CollaborationBAVMostRecent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      APIResponse: "",
      cardCounts:sessionStorage.getItem("MrbavCardCount")?parseInt(sessionStorage.getItem("MrbavCardCount")):4,
      DeleteSubmit: false,
  ...
  componentDidMount() {
    this.getAllIdeas();
    if(sessionStorage.getItem("MrbavCardCount"))
    {
  ...
  getAllIdeas() {
    ...
    fetch(
      process.env.REACT_APP_API_URL+"Volunteer/GetVolunteers",
      requestOptions
    )
  ...
  CardDetails = (CardID) => {
    if (
      ...
      sessionStorage.setItem("MrbavCardCount",this.state.cardCounts);
  ...
  LoadMore_SAT() {
    console.log("cards count",this.state.cardCounts)
    ...
    if (this.state.cardCounts <= 100) {
      ...
      console.log("card count after adding = ", this.state.cardCounts);
      this.getAllIdeas();
    }
  }
      ...
      <Container className="tab-card-container-style">
        <Row>
          ...
          {this.state.shareIcons.map((CardValues, index) => (
            <Col xs="12" sm="12" md="6" lg="6" xl="6" xxl="6">
              <Card className="tab-card-style" ref={(sessionStorage.getItem("VolunteerId")==CardValues.volunteer_id) ? this.Refforcard:""}>
        ...
        <Row>
          ...
          <Col xs="12" sm="12" md="8" lg="8" xl="8" xxl="8">
            {((this.state.totalCardCount > this.state.cardCounts) && (100 > this.state.cardCounts)) && (
              <Button
